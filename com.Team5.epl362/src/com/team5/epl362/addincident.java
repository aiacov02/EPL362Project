...
//	}
	 ...
	 */
	public addincident(ClinicalStaff clinicalstaff) {
	...
	private void initialize() {
		frame = new JFrame();
		frame.setTitle("Προσθήκη Περιστατικού");
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				clinicalstaff.addIncident(Integer.parseInt(textField.getText()), textField_1.getText(), textArea.getText() );
